...
def Func_fitting_plot(N,X0,Y0):
    ...
    plt.scatter(X0, Y0, color=p_color[order_color], s=10, color=p_color[order_color], alpha=0.6)
    plt.xlabel('Distance')
...
def Jacard_boxplot(dis0,X_distance,Y_jaccard):  #plot th boxplot for diffrent dstance 20 -100
    ...
    # plt.scatter(X_distance, Y_jaccard, c=p_color[int(1 - math.log((push_rate), 2))], s=10, color=p_color[order_color], alpha=1)
    # plt.xlabel('Distance')
    # plt.ylabel("Jaccard index")
    ...
    # plt.scatter(X0, Y0, c=p_color[int(1-math.log((push_rate),2))],s=10, color=p_color[order_color],alpha=1)
    # plt.xlabel('Distance')
    # plt.ylabel("Jaccard index")
    # plt.legend(labels='',loc='upper right', shadow=bool, title='Jaccard Num= {}'.format(len(Y0)), numpoints=None)
    # popt, pcov = curve_fit(jaccard_func, X0, Y0)
...
if __name__ == "__main__":
    ...
    for i_cut in range(1,7):
        for i_ra in range(1,sample_size+1):
            ...
            if i_cut == 1:
                ...
                # plt.scatter(VAF_f11, VAF_cumulative11, s=10, color=p_color[order_color])
            ...
            if i_cut == 2:
                ...
                # plt.scatter(VAF_f12, VAF_cumulative12, s=10, color=p_color[order_color])
            ...
            if i_cut == 3:
                ...
                # plt.scatter(VAF_f13, VAF_cumulative13, s=10, color=p_color[order_color])
                ...
                # plt.ylabel("Cumulative Number of Mutation")
                jacard_run(XY_range3, all_mutation_dict3)
            # 14 slice
            if i_cut == 4:
                ...
                # plt.scatter(VAF_f14, VAF_cumulative14, s=10, color=p_color[order_color])
                ...
                # plt.ylabel("Cumulative Number of Mutation")
                jacard_run(XY_range4, all_mutation_dict4)
            # slice 15
            if i_cut == 5:
                ...
                # plt.scatter(VAF_f15, VAF_cumulative15, s=10, color=p_color[order_color])
                ...
                # plt.ylabel("Cumulative Number of Mutation")
                jacard_run(XY_range5, all_mutation_dict5)
            # slice 16
            if i_cut == 6:
                ...
                # plt.scatter(VAF_f16, VAF_cumulative16, s=10, color=p_color[order_color])
                ...
                # plt.ylabel("Cumulative Number of Mutation")
                jacard_run(XY_range6, all_mutation_dict6)
    ...
    #
    # plt.figure('jacard_index', figsize=[5, 5])
    # plt.scatter(X_distance, Y_jaccard, c='goldenrod',s=10, color=p_color[order_color])
    # plt.xlabel('Distance')
    # plt.ylabel("Jaccard index")
    # plt.legend(labels='',loc='upper right', shadow=bool, title='Jaccard Num= {}'.format(len(Y_jaccard)), numpoints=None)
    # a1, b1 = jacard_run1
    ...
    for i, j, z in zip(all_VAF_f11, all_VAF_cumulative11, all_VAF_number11):
        ...
        plt.scatter(i, j, s=10, color=p_color[order_color])
    ...
    plt.bar(VAF_mu, VAF_times, width=0.005, color=p_color[order_color], alpha = 0.6)
    plt.ylim(0, 200)
    plt.xlabel('VAF')
    ...
    plt.figure('Whole VAF2', figsize=[5, 5])
    ...
    plt.xlim(0,5000)
    plt.ylim(0,50000)
    print('P=',push_rate, 'Cancer number:',cancer_num)
    maps = matplotlib.colors.ListedColormap(
    ...
    plt.imshow(cell_matrix, cmap=maps)
    ...
    pdf = matplotlib.backends.backend_pdf.PdfPages('SSS17+{}.pdf'.format(random.randint(1,100)) )
