...
def Jacard_boxplot( n,X_distance,Y_jaccard):
    p1=20
    p2=40
    p3=60
    p4=80
...
if __name__ == "__main__":
    ...
    Jacard_boxplot(1,jacard_run1[0],jacard_run1[1])
    Jacard_boxplot(2,jacard_run2[0],jacard_run2[1])
    Jacard_boxplot(3,jacard_run3[0],jacard_run3[1])
    Jacard_boxplot(4,jacard_run4[0],jacard_run4[1])
    Jacard_boxplot(5,jacard_run5[0],jacard_run5[1])
    Jacard_boxplot(6,jacard_run6[0],jacard_run6[1])
    ...
    pdf = matplotlib.backends.backend_pdf.PdfPages('0.1+{}.pdf'.format(cancer_num))
